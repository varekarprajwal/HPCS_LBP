...
int main( int argc, char* argv[]) {
    ...
    int ofset_r=0,ofset_text=0,ofset=1,ofset_ss=0,ofset_sss=0,r_ofset_r=0;
    int rank_offset[size]={0},s_rank_offset[size]={0};
...
if(rank >=0 && rank <size-2 ){
    ...
    for (i = 0; i <3*t_m_r; ) {
        for (j = 0; j < t_m_c; j++) {
            txt_img[lk][rk]=my_r_texton[(rank*t_m_r)+i+j];
